...
const NavBar = () => {
    ...
    const navItems = <>
        ...
        <Link to={'/applyJobs'} className="btn bg-primary hover:bg-transparent text-white hover:text-black hover:border-black "><li>Applied Jobs</li></Link>
        {
            user && <>
                <Link to={'/addJobs'}>
        ...
        <div>
            ...
            <div className="navbar bg-base-100">
                <div className="navbar-start">
                    ...
                    <Link to={'/'} className="btn hidden lg:flex bg-slate-400"><span className="self-center text-2xl text-white hover:text-black font-semibold">Easy<span className="text-primary">Hire</span></span></Link>
                </div>
                ...
                <div className="navbar-end">
                    ...
                    
                    {
                        user ?
                            ...
                            <>
                                <NavLink to={'/logIn'}>
                                    <button className="btn bg-primary hover:bg-transparent text-white hover:text-black hover:border-black  mr-3" >Login</button>
                                </NavLink>
                                <NavLink to={'/registration'}>
                                    <button className="btn bg-primary hover:bg-transparent text-white hover:text-black hover:border-black ">Registration</button>
                                </NavLink>
                            </>
